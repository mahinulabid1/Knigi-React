            ...
            <section className={"flex flex-wrap flex-s-b " + styles.storiesSection}>
                <div className={styles.flexItem}>
                    ...
                    <div className={styles.imageContainer + " flex flex-wrap flex-s-b"}>
                        <img className = {styles.imageStories} src="./images/singleStories/stories1.jpg" alt=""/>
                        <img className = {styles.imageStories} src="./images/singleStories/stories2.jpg" alt=""/>
                        <img className = {styles.imageStories} src="./images/singleStories/stories3.jpg" alt=""/>
                        <img className = {styles.imageStories} src="./images/singleStories/stories4.jpg" alt=""/>
                        <img className = {styles.imageStories} src="./images/singleStories/stories5.jpg" alt=""/>
                        <img className = {styles.imageStories} src="./images/singleStories/stories6.jpg" alt=""/>
                        <img className = {styles.imageStories} src="./images/singleStories/stories8.jpg" alt=""/>
                    </div>
                </div>
                <div className={styles.flexItem}>
