        ...
        <>
            ...
            <section className="stories-section">
                <div className="flex-item">
                    ...
                    <h3 className="stories-sub-header">CRÉ NATURAL BUILDING <span className="sub-header-span">ARCHITECTURE</span></h3>
                    <div className="image-container-mother">
                        <div className="mobile-desktop-img"><img className="m-d-image-tag image-stories" src=".images/singleStories/stories7.jpg" alt=""/></div>
                        <div className="desktop-image">
                            <img className="desktop-image-tag image-stories" src="./images/singleStories/stories1.jpg" alt=""/>
                            <img className="desktop-image-tag image-stories" src="./images/singleStories/stories2.jpg" alt=""/>
                            <img className="desktop-image-tag image-stories" src="./images/singleStories/stories3.jpg" alt=""/>
                            <img className="desktop-image-tag image-stories" src="./images/singleStories/stories4.jpg" alt=""/>
                            <img className="desktop-image-tag image-stories" src="./images/singleStories/stories5.jpg" alt=""/>
                            <img className="desktop-image-tag image-stories" src="./images/singleStories/stories6.jpg" alt=""/>
                            <img className="desktop-image-tag image-stories" src="./images/singleStories/stories8.jpg" alt=""/>
                        </div>
                    </div>
                </div>
                <div className="flex-item">
                    <div className="first-section-para para">
                    ...
                    <div className="second-para para">
                    ...
                    <div className="third-para para">
                        <p className="para-heading">What are some of the chief characteristics of a natural building?</p>
                    ...
                    <div className="fourth-para para">
